...
Limited information about calculation, but the shapefile used is not as accurate as the one I'm using from GADM. Calculation information:
...
Okay, so this is higher than either of the figures Matt Parker found... this is likely to be an issue with how detailed the underlying shapefiles being used are, or if raster data the spatial resolution. 
